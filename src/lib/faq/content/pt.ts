...
export const pt: Record<string, FaqContent> = {
  ...
  "choosing-first-racket": {
    ...
    status: "machine",
    answerMd:
      "Para começar, procura uma pá **redonda**. A forma determina onde fica o ponto ideal de impacto:\n\n- **Redonda** — ponto ideal ao centro e maior, perdoa impactos descentrados. É a forma indicada para quem começa.\n- **Lágrima** — equilíbrio entre controlo e potência.\n- **Diamante** — ponto ideal alto e pequeno, dá mais potência mas castiga qualquer imprecisão. Não é uma pá para as primeiras semanas.\n\nProcura também uma pá mais leve e com núcleo macio: cansa menos o braço e é mais confortável no impacto. O regulamento fixa limites de comprimento, largura, espessura e furação, e obriga ao cordão de pulso — está tudo na regra da pá. Dentro desses limites cabe tudo o que encontras à venda, e a diferença que vais sentir está na forma, no peso e no material, não nas medidas.",
  },
  "padel-balls": {
    question: "As bolas de padel são iguais às de ténis?",
    status: "machine",
    answerMd:
      "Parecem-se muito, e a pergunta a seguir é sempre a mesma: posso usar as de ténis que tenho em casa?\n\n**Em competição, não.** O regulamento da FIP fixa o que uma bola de padel tem de cumprir: diâmetro entre 6,35 e 6,77 cm, peso entre 56,0 e 59,4 gramas, e um ressalto entre 135 e 145 cm quando largada de 2,54 metros sobre superfície dura. Uma bola fora desta janela não serve para jogo oficial.\n\n**Num jogo entre amigos, ninguém te impede** — mas repara no que muda: o ressalto é o que define o jogo num campo pequeno onde a bola volta das paredes, e é precisamente esse valor que o regulamento aperta. É também por isso que uma bola de padel gasta acaba por estragar um jogo: perde pressão, ressalta menos, e os pontos deixam de sair como deviam.\n\nAcima dos 1000 metros de altitude o regulamento admite bolas de ressalto mais baixo, porque o ar mais rarefeito as faz saltar mais.",
  },
  "national-ranking": {
